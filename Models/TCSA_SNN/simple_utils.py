...
def summarize_eco2ai_log(path="eco2ai_logs.csv"):
    ...
    plt.savefig("TCSA_SNN_power_consumption_plot.png")
    print("✅ Power consumption plot saved as 'TCSA_SNN_power_consumption_plot.png'.")
    plt.show()
    plt.close()
    ...
    plt.tight_layout()
    plt.xticks(rotation=45)
    plt.savefig("TCSA_SNN_co2_emission_plot.png")
    print("✅ CO₂ emission plot saved as 'TCSA_SNN_co2_emission_plot.png'.")
    plt.show()
    plt.close()